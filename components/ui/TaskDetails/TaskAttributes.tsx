...
const TaskAttributes = ({ start_date, end_date, severity, progress, task_id }: TaskAttributesProps) => {
    return (
        <Grid templateAreas={{
            ...
            <UpdateEndDate task_id={task_id} start_date={start_date} end_date={end_date} />
            <UpdateSeverity task_id={task_id} severity={severity} />
            <UpdateProgress task_id={task_id} progress={progress} />
        </Grid>
    )
}

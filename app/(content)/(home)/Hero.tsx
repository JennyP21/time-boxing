...
const Hero = () => {
    return (
        <Grid
            ...
            bgGradient="linear(to-br, slate.900, indigo.950)"
            color="white"
        >
            <Flex className='flex-col gap-6 text-left items-start max-w-2xl'>
                <Heading className='tracking-tight leading-none font-extrabold' size={{ base: "xl", md: "2xl" }}>
                    Unify Tasks. Unleash Potential. <Text as="span" bgGradient="linear(to-r, indigo.300, pink.300)" bgClip="text">Achieve More.</Text>
                </Heading>
